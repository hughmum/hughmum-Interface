...
export const requestConfig: RequestConfig = {
  //baseURL: 'http://122.9.148.119:88',
  baseURL: 'http://101.43.133.162:88',
  ...
  responseInterceptors: [
    (response) => {
      ...
      if ((data.code !== 0 && data.code !== 200) && response.headers['content-type'] !== 'image/jpeg' && response.headers['content-type'] !== 'text/html;charset=utf-8') {
