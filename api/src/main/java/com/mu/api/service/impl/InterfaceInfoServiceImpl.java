...
import com.mu.api.common.RedisTemplateUtils;
...
import com.mu.api.model.entity.InterfaceCharging;
...
import com.mu.api.service.InterfaceChargingService;
...
public class InterfaceInfoServiceImpl extends ServiceImpl<InterfaceInfoMapper, InterfaceInfo>
    ...
    public BaseResponse<Long> addInterfaceInfo(InterfaceInfoAddRequest interfaceInfoAddRequest, HttpServletRequest request) {
        ...
        Double charging = interfaceInfoAddRequest.getCharging(); //得到计费规则
        String availablePieces = interfaceInfoAddRequest.getAvailablePieces(); //可调用次数
        // 添加接口对应的计费规则到数据库
    ...
    public BaseResponse<Page<AllInterfaceInfoVo>> listInterfaceInfoByPage(InterfaceInfoQueryRequest interfaceInfoQueryRequest) {
        ...
        long current = interfaceInfoQueryRequest.getCurrent(); //获取当前页号
        // 查询redis里面的分页缓存
